...
class Student(models.Model):
    ...
    former_surname = models.CharField(max_length=100)
    ...
    room_capacity_preference = models.PositiveIntegerField(null=True, blank=True)
    ...
    address_of_next_of_kin = models.CharField(max_length=100)
    phone_number_of_next_of_kin = models.CharField(max_length=100)
    email_of_next_of_kin = models.EmailField(blank=True, null=True)
    ...
    def __str__(self):
        return str(self.name) + ' | ' + str(self.matric_number)
